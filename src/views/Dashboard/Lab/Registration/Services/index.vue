    ...
    async prefillServicesForm(service) {
      try{
        ...
        const formatPrice = (price, currency) => {
          if (currency === "USDT") {
            return this.web3.utils.fromWei(price.replaceAll(",", ""), "mwei")
          } else {
            return this.web3.utils.fromWei(price.replaceAll(",", ""), "ether")
          }
        }
        ...
        const currency = pricesByCurrency[0].currency
        ...
        this.document = { 
          ...
          currency: currency,
          price: formatPrice(pricesByCurrency[0].priceComponents[0].value, currency),
          qcPrice: formatPrice(pricesByCurrency[0].additionalPrices[0].value, currency),
